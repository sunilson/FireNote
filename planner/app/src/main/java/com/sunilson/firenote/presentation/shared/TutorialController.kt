        ...
        val showCaseView = ShowcaseView.Builder(activity)
                ...
                .setShowcaseEventListener(object : OnShowcaseEventListener {
                    override fun onShowcaseViewHide(showcaseView: ShowcaseView) {
                        ...
                        findViewById<View>(R.id.main_element_sort).setEnabled(false)
                        ShowcaseView.Builder(activity)
                                ...
                                .setShowcaseEventListener(object : OnShowcaseEventListener {
                                    override fun onShowcaseViewHide(showcaseView: ShowcaseView) {
                                        findViewById<View>(R.id.main_element_sort).setEnabled(true)
                                        if (findViewById<View>(R.id.main_element_visibility) != null) {
                                            findViewById<View>(R.id.main_element_visibility).setEnabled(false)
                                            ShowcaseView.Builder(this@MainActivity)
                                                    ...
                                                    .setShowcaseEventListener(object : OnShowcaseEventListener {
                                                        override fun onShowcaseViewHide(showcaseView: ShowcaseView) {
                                                            findViewById<View>(R.id.main_element_visibility).setEnabled(true)
                                                        }
