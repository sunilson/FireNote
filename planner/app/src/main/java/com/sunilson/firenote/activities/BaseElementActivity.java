...
public abstract class BaseElementActivity extends BaseActivity implements ElementInterface, ConfirmDialogResult {
    ...
    /**
     * Set up the listener for the element data
     */
    protected void initializeElementListener() {
        mElementListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (element != null) {
                    //Check if element is valid (if it has no noteType but is not null, it must be partial data, which is not valid --> remove)
    ...
    /**
     * Apply new data from listeners
     *
     * @param element Element with new data
     */
